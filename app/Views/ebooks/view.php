    ...
    <div class="row ">
        ...
        <div class="col-md-12">
            ...
            <ol class="breadcrumb py-0">
                ...
                <li class="breadcrumb-item"><a href="?view=ebooks">E-books</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo $ebook->ACCESSION_NO;?></li>
            </ol>
        </div>
        <div class="col-12">
        ...
        <div class="col-sm-12 col-md-12 col-lg-3">
            <div class="mt-3 mb-3 text-center">
                <img class="rounded" src="<?php echo $ebook->COVER_SOURCE;?>" width="255" height="380">
            </div>
            <div class="mt-3 mb-3 text-center">
                <img class="rounded" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=http://localhost/staging/cvsu_ils/?view=ebook&id=<?php echo $ebook->ID;?>" height="150px" width="150px">
            </div>
            <div class="my-3">
                <?php
                    if(substr($ebook->ACCESSION_NO, 0, 4) == 'OEBP') {
                        echo '<a class="btn d-block btn-success" href="services.php?id=' . $ebook->ID . '" style="border: 1px solid #1a722e; box-shadow: inset 0 -3px 0 0 #1a722e;" target="_blank">Request access</a>';
                        echo '<p class="mt-5 px-2 text-muted">Accessibility: <span class="badge badge-danger">Purchased</span></p>';
                    } else {
                        echo '<a class="btn d-block btn-success" href="' . $ebook->LINK . '" style="border: 1px solid #1a722e; box-shadow: inset 0 -3px 0 0 #1a722e;" target="_blank">View full contents</a>';
        ...
        <div class="col-sm-12 col-md-12 col-lg-9">
            <div class="container pt-3 px-3">
                <div class="pb-3">
                    ...
                    <?php
                        if(!empty($ebook->RELATORS)) {
                            echo '<p class="text-muted">';
                            $relator = '';
                            $i = 0;
                            foreach($ebook->RELATORS as $relator) {
                                if($i == 0) {
                                    echo count($ebook->RELATORS) > 1 ?  '[' . $relator->TYPE . 's] ' :  '['. $relator->TYPE . '] ';
                                }
                                echo $relator->NAME;
                                $i++;
                                echo $i != count($ebook->RELATORS) ? ' -- ' : '';
                            }
                            echo '</p>';
                        } else {
                            if($googleBooks->totalItems > 0) {
                                $authors = $googleBooks->items[0]->volumeInfo->authors;
                                if(!empty($authors)) {
                                    echo '<p class="text-muted">By: ';
                                    $i = 0;
                                    foreach($authors as $author) {
                                        echo $author;
                                        $i++;
                                        echo $i != count($authors) ? ' -- ' : '';
                                    }
                                    echo '</p>';
                                }
                            }
                    ...
                    <?php
                        if($googleBooks->totalItems > 0) {
                            if(!empty($googleBooks->items[0]->volumeInfo->description)) {
                                echo '<hr><p class="text-muted mb-0">Description</p><p class="text-justify">' . $googleBooks->items[0]->volumeInfo->description . '</p>';
                            }
                        }
                    ?>
                    <hr>
                    ...
                    <ul class="ils-details">
                        <li>
                            ...
                            <span><b><?php echo $ebook->ACCESSION_NO;?></b></span>
                        </li>
                        <li>
                            <span>Call Number: </span>
                            <span><b><?php echo $ebook->CALL_NO;?></b></span>
                        </li>
                        <li>
                            <span>ISBN: </span>
                            <span><?php echo $ebook->ISBN;?></span>
                        </li>
                        <li>
                            <span>Edition: </span>
                            <span><?php echo $ebook->EDITION;?></span>
                        </li>
                        <li>
                            <span>Publisher: </span>
                            <span><?php echo $ebook->PUBLISHER;?></span>
                        </li>
                        <li>
                            <span>Copyright Year: </span>
                            <span><?php echo $ebook->COPYRIGHT_YEAR;?></span>
                        </li>
                        <li>
                            <span>Notes: </span>
                            <span><?php echo $ebook->NOTES;?></span>
                        </li>
                        <li>
                            <span>Subjects: </span>
                            <?php
                                if(!empty($ebook->SUBJECTS)) {
                                    echo '<ol>';
                                    foreach($ebook->SUBJECTS as $subject) {
                                        echo '<li>' . $subject .'</li>';
                                    }
                                    echo '</ol>';
                                }
